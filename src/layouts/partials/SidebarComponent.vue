  ...
  >
    <div class="mb-4 px-4">
      ...
      >
        ...
        <span class="text-gray-700">Analítica</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
    ...
    <div class="mb-4 px-4">
      ...
      >
        ...
        <span class="text-gray-700 q-ml-sm">Sucy</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      ...
      >
        ...
        <span class="text-gray-700 q-ml-sm">Tipos</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
      ...
      >
        ...
        >
          <path
            d="M740-480v-195.69l-84 83.23L628.46-620 760-751.54 891.54-620 864-591.46l-84-84V-480h-40ZM116.15-153.08l167.7-224.61 138.46 184.61h341.54l-200-266-120 159.7-25.39-33.7 145.39-193.84 280 373.84h-727.7Zm327.7-40Z"
          />
        </svg>
        <span class="text-gray-700 q-ml-sm">Niveles</span>
      </div>
    </div>
    ...
    <div class="mb-4 px-4">
      ...
      >
        ...
        <span class="text-gray-700">Controles</span>
      </div>
      <div
        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
        ...
        <span class="text-gray-700">Ajustes</span>
      </div>
    </div>
  </q-scroll-area>
</template>
